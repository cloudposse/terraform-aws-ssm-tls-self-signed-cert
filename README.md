...
| <a name="input_show_private_key"></a> [show\_private\_key](#input\_show\_private\_key) | Feature flag indicating to enable display of private key output. The private key is considered sensitive. | `bool` | `false` | no |
...
| <a name="output_private_key_pem"></a> [private\_key\_pem](#output\_private\_key\_pem) | Contents of private key pem. This value is sensitive. It requires enabling the `show_private_key` flag. |
<!-- markdownlint-restore -->
